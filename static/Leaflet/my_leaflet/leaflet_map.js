...
var toolTitle = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this._div.innerHTML = "1. Select Area";
        return this._div;
    }
});
...
function swapLegend(layerToAddName, layerToAdd, climateVariable) {
    if ((! map.hasLayer(climate_PNG_overlay) && ! map.hasLayer(layerToAdd)) || layerToAddName == 'single_transparent_pixel') {
        ...
        if (layerToAddName == 'intactness' || layerToAddName == 'conservation_value') {
        ...
        else if (layerToAddName == 'ownership') {

            label_6="BLM";
            label_5="Military";
            label_4="Native American";
            label_mid="Other";
            label_3="Private";
            label_2="State Land";
            label_1="USFS"
        ...
        else if (layerToAddName == 'species_count') {
        ...
        '<tr><td rowspan="8" style="padding-top:0px"><img height="' + legend_height + '" src="'+static_url+'Leaflet/my_leaflet/legends/' + legend_image + '.png"></td>' +
...
var reportingUnitLayers = {"Counties": counties, "BLM Field Offices": blm_field_offices,"HUC5 Watersheds": huc5_watersheds,"User Defined (1km)": onekm};
...
function create_post(newWKT) {
    ...
    $.ajax({
        ...
        error : function(xhr,errmsg,err) {
            ...
            alert('No results. Select a new area or modify your criteria.')
